    ...
    <div className="w-full max-w-md mx-auto relative">
      ...
      <AnimatePresence mode="wait">
        {state === 'EMAIL' ? (
          ...
          >
            <div className="mb-8">
              <h1 className="text-3xl font-display font-semibold text-text-1 mb-2">Welcome back</h1>
              <p className="text-text-2 text-sm">Log in to your StockUp account to continue your journey.</p>
            </div>
